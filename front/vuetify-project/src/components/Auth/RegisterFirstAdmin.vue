      ...
      <v-col cols="12" sm="8" md="6" lg="4">
        <v-card class="elevation-12">
          <v-toolbar color="primary" dark flat>
            <v-toolbar-title>Registrar Primer Administrador</v-toolbar-title>
          </v-toolbar>
          <v-card-text>
  ...
  methods: {
    async register() {
      ...
      try {
        ...
        this.success = 'Administrador registrado correctamente. Redirigiendo al login...';
